 ...
 * Countdown Timer
 *
 * Logger is a utility class that allows the developer to turn off logging by
 * setting the LOGGING flag to false prior to generating an APK.
 *
 * @author Shane King 28 Aug 2014 10:00
 */
public class Logger {
