package com.smart.vehicletypesettings;
...
public class DBAdapter extends SQLiteOpenHelper {
	...
	private static final String DB_NAME = "vehicleparking.sqlite";
	 ...
	 */
	public Cursor selectRecordsFromDB(String tableName, String[] tableColumns, String whereClase, String whereArgs[],
	...
	public ArrayList<ArrayList<String>> selectRecordsFromDBList(String tableName, String[] tableColumns,
			String whereClase, String whereArgs[], String groupBy, String having, String orderBy) {
	 ...
	 */
	public boolean updateRecordInDB(String tableName, ContentValues initialValues, String whereClause,
			String whereArgs[]) {
	 ...
	 */
	public int updateRecordsInDB(String tableName, ContentValues initialValues, String whereClause,
			String whereArgs[]) {
	...
	public int getTranslatesCount(String userid, String password) {
		String countQuery = "SELECT  * FROM userinfo where userid='" + userid + "'and password='" + password + "'";
